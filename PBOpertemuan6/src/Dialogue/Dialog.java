...
public class Dialog extends javax.swing.JFrame {
    ...
    private void setupDialogProperties() {
        ...
        setResizable(false);
        // JFrame menggunakan DISPOSE_ON_CLOSE bukan EXIT_ON_CLOSE
    ...
    private boolean isPerangkatDuplicate(String merek, String nama, String model) {
        try {
            String query = "SELECT COUNT(p) FROM PenjualanPerangkatElektronik_1 p WHERE "
    ...
    private String getCurrentModel(String nomorSeri) {
        try {
            PenjualanPerangkatElektronik_1 data = em.find(PenjualanPerangkatElektronik_1.class, nomorSeri);
            return data != null ? data.getModelPerangkat() : "";
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
    ...
    private boolean executeInsert() {
        try {
            ...
            // Buat entity baru menggunakan class yang sudah ada di persistence.xml
    ...
    private boolean executeUpdate() {
        try {
            // Dapatkan data existing
            PenjualanPerangkatElektronik_1 existingData = em.find(PenjualanPerangkatElektronik_1.class, getNomorSeri());
    ...
    private boolean executeDelete() {
        try {
            ...
            PenjualanPerangkatElektronik_1 dataToDelete = em.find(PenjualanPerangkatElektronik_1.class, getNomorSeri());
